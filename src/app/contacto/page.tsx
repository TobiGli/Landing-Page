...
export default function Example() {
  ...
  <>
    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]" style={{ pointerEvents: 'none' }}
      >
        <div
          style={{
            clipPath:
          ...
          className="padding-bottom relative left-1/2 -z-40 aspect-1155/678 w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Field className="flex gap-x-4 sm:col-span-2">
            ...
            <Label className="text-sm/6 text-gray-600">
              Seleccionando esto, aceptas nuestras{' '}
              <a href="./privacy-politics" className="font-semibold text-indigo-600">
